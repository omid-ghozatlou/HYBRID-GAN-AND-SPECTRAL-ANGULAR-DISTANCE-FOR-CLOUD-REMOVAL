...
import numpy as np
#----------------------------- full 12 bands ---------------------------------------
path = "D:/Sciebo/ESR14/cloud removal/dataset/S2B_MSIL2A_20200319T105649_N0214_R094_T31UDQ_20200319T142847.SAFE" # directory of patches includes 12 bands
...
n=1312 # number of patches of each band   
for i in range(n):
